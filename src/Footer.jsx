    ...
    <footer className="bg-gray-100 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-blue-600">DreamJob</h1>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Companies</a></li>
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Advice</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Help Docs</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Guide</a></li>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Get job notifications</h3>
